...
module.exports = __webpack_require__(/*! ./frontend/main.js */3);
...
__webpack_require__(/*! modernizr-loader!json-loader!./.modernizrrc */ 4);
__webpack_require__(/*! ./polyfills.js */ 5);
__webpack_require__(/*! apply!callback!./components.js */ 6);
...
var req = __webpack_require__(/*! !./node_modules/callback-loader/callback-loader.js!./node_modules/babel-loader/lib??ref--1!./frontend/components.js */ 7);
...
module.exports = function () {
	__webpack_require__(/*! ./frontend/components/core/core.js */ 8);
__webpack_require__(/*! ./frontend/components/list/list.js */ 9);
__webpack_require__(/*! ./frontend/components/scheme/scheme.js */ 13);;
};
...
new _vue2["default"]({
  ...
  mounted: function mounted() {
    ...
    $.get("https://api.myjson.com/bins/m4a6k", function (data) {
      if (!data.news || data.news && data.news.length === 0) {
        _this.hasError = true;
      } else {
        _this.firstArticle = data.news[0];
        _this.articlesShown = data.page.total;
        _this.articlesToShow = data.page.total;
        _this.news = data.news.slice(1);
      }
    }).fail(function (err) {
      _this.hasError = true;
    });
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(/*! ./../../process/browser.js */ 1), __webpack_require__(/*! ./../../webpack/buildin/global.js */ 0), __webpack_require__(/*! ./../../timers-browserify/main.js */ 11).setImmediate))
